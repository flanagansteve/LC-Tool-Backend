# Generated by Django 3.0.3 on 2020-03-20 02:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('draft_accompiant_invoice', models.CharField(blank=True, max_length=250, null=True)),
                ('draft_accompiant_transport_docs', models.CharField(blank=True, max_length=250, null=True)),
                ('doc_reception_notifees', models.CharField(blank=True, max_length=250, null=True)),
                ('transport_doc_marking', models.CharField(blank=True, max_length=250, null=True)),
                ...
                ('insurance_percentage', models.DecimalField(decimal_places=5, default=0.0, max_digits=6)),
                ('insurance_risks_covered', models.CharField(blank=True, max_length=250, null=True)),
                ('other_draft_accompiants', models.CharField(blank=True, max_length=1000, null=True)),
